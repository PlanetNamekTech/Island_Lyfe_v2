const {islandSchema, reviewSchema} = require('./schemas'),
      ExpError = require('./Utils/ExpError'),
...
module.exports.validateIsland = (req,res,next) => {
...
module.exports.isAuthor = async(req,res,next) => {
  ...
  if(!island.author.equals(req.user._id)) {
    req.flash('error', 'You do not have permission to do that');
    return res.redirect(`/islands/${id}`)
  }
  next();
}
